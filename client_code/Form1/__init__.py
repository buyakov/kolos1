...
class Form1(Form1Template):
  ...
  def drop_down_1_change(self, **event_args):
    ...
    # присваиваем переменным cad (кадастровый номер) и
    # sq (площадь участка) значения из таблицы по номеру участка num
    ...
    cc_date_entering = response['feature']['attrs']['cc_date_entering'] #дата внесения сведений
    area_value = response['feature']['attrs']['area_value']
