...
class Form1(Form1Template):
  def __init__(self, **properties):
    ...
    iframe_yandex = jQuery("<iframe width='100%' height='500' frameborder='0'>").attr("src","https://yandex.ru/map-widget/v1/?um=constructor%3A8c78e07a751d5a9e657860e397d28e92a92ff8ebc0fb8a8ba7be72ea7417b931&amp;source=constructor")
    iframe_google = jQuery("<iframe width='100%' height='500' frameborder='0'>").attr("src","https://www.google.com/maps/d/embed?mid=1Va23cJVcImyNFZfrASGqnYF-aqVdHzQ&ehbc=2E312F&noprof=1")
